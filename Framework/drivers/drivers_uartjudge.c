...
float realHeat;
float realBulletSpeed = 22;
uint8_t realLevel;
uint16_t maxHP = 1500;
uint16_t remainHP;
uint16_t maxHeat = 360;
uint16_t remainHeat = 360;
...
void Judge_Refresh_State()
{
	...
	switch(maxHP)
	{
		case 750:maxHeat = 90;break;
		case 1000:maxHeat = 180;break;
		case 1500:maxHeat = 360;break;
		default:maxHeat = 360;break;
	}
	JUDGE_Received = 1;
}
...
{
	unsigned char * bsd = (unsigned char*)&ShootData.bulletSpeed;
